...
fun homeNativeAd(): Long = 2056709529737105408
fun homeInterstitialAd(): Long = 2056709465545510912
fun bottomTabSwitchInterstitialAd(): Long = 2057060312322412544
fun swipeNativeAd(): Long = 2057058885453484032
fun swipeInterstitialAd(): Long = 2057060386819149824
fun compressNativeAd(): Long = 2057059251504418816
fun compressInterstitialAd(): Long = 2057060460884529152
fun toolsNativeAd(): Long = 2057059351160295424
fun toolsInterstitialAd(): Long = 2057060560213905408
fun detailNativeAd(): Long = 2057059564318887936
fun detailInterstitialAd(): Long = 2058842773889355776

fun homeTabBanner(): Long = homeNativeAd()
fun settingNative(): Long = 2057059661990989824
fun permissionNative(): Long = 2057059860664946688
fun songTabBanner(): Long = swipeNativeAd()
fun albumTabBanner(): Long = compressNativeAd()
fun artistTabNative(): Long = toolsNativeAd()
...
fun allDetBanner(): Long = detailNativeAd()
fun zhuanTabInter(): Long = homeInterstitialAd()
...
fun backSpecialToCy(): Long = detailInterstitialAd()
